#
#  Be sure to run `pod spec lint MusicNotation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
    ...
    s.name         = "MusicNotation"
    s.version      = "0.1.1"
    s.summary      = "An Objective-C music notation rendering framework."
    ...
    s.description  = <<-DESC
    A music notation rendering library for iOS and Mac.
    DESC
    
    s.homepage     = "https://github.com/slcott/MusicNotation"
    ...
    s.author             = { "slcott" => "s.riccardelli@gmail.com" }
    # Or just: s.author    = "slcott"
    # s.authors            = { "slcott" => "s.riccardelli@gmail.com" }
    # s.social_media_url   = "http://twitter.com/slcott"
