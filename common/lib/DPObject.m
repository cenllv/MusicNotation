...
- (NSMethodSignature*)methodSignatureForSelector:(SEL)aSelector
{
    ...
    if(propertyName)
    {
        ...
        return
            [NSMethodSignature signatureWithObjCTypes:[[NSString stringWithFormat:@"%@@:", propertyType] UTF8String]];
    }
    ...
    if(propertyName)
    {
        ...
        NSString* propertyType = property.encoding;
        return
            [NSMethodSignature signatureWithObjCTypes:[[NSString stringWithFormat:@"v@:%@", propertyType] UTF8String]];
    }
